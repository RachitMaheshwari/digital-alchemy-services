...
const PriceCard = ({
  ...
  return (
    <Card className={`relative h-full flex flex-col transition-all duration-300 hover:shadow-md ${isPopular
        ...
        <ul className="space-y-3">
          {features.map((feature, index) => (
            <li key={index} className="flex items-start">
              <div className={`p-0.5 rounded-full mr-2 mt-1 ${isPopular ? 'bg-techpro-purple/20 text-techpro-purple' : 'bg-gray-100 text-gray-700'
                }`}>
                <Check size={12} />
              </div>
